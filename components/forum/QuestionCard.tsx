...
export default function QuestionCard({ q }: { q: any }) {
  return (
    <div className="group bg-gradient-to-br from-slate-800/90 to-slate-700/90 backdrop-blur-xl rounded-2xl border border-slate-600/30 p-6 shadow-2xl hover:shadow-3xl hover:scale-[1.02] transition-all duration-300">
