...
export default function NewResponseForm({ questionId, onCreated }:{ questionId: string; onCreated?: ()=>void }) {
  ...
  return (
    <form onSubmit={submit} className="space-y-4 sm:space-y-6">
      <div>
        <label className="block text-sm sm:text-base lg:text-lg font-semibold text-blue-200 mb-2 sm:mb-3">
          Viết phản hồi
        </label>
        <textarea 
      ...
      >
        {loading ? (
          <>
            ...
            <span className="animate-pulse text-xs sm:text-sm lg:text-base">Đang gửi phản hồi...</span>
