            ...
            <Link href="/" className="flex items-center space-x-2 sm:space-x-4 group">
              <div className="relative">
                <img
                  ...
                  width={44}
                  height={44}
                  className="rounded-full glow transition-all object-cover w-11 h-11"
                />
                <div className="absolute inset-0 rounded-full border-2 border-accent" aria-hidden="true" />
              </div>
              <div className="flex items-center gap-2">
                <span suppressHydrationWarning className="font-heading text-foreground font-extrabold tracking-wide leading-none text-[44px]">FTC</span>
